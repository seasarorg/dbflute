...
function browserCheck() {
	...
	if (browser.indexOf('msie')!=-1) {
		if(browser.substring(browser.indexOf('msie')+5,browser.indexOf('.',browser.indexOf('msie')))>5) return("ie");
		else return("ie_old");
	}
...
function resizePage() {
	...
	changeCSS('#tmpRF','height',top.document.body.clientHeight-70+'px','this');
	rFStatus=0;
}
...
function setCSS() {
	if (browser=="ie") {
		...
		changeCSS('#contentIFrame','height',top.document.body.clientHeight-74+'px','this');
		...
		changeCSS('#resizeFrames','height',top.document.body.clientHeight-70+'px','this');
		changeCSS('#tmpRF','border','0px','this');
		changeCSS('#tmpRF','height',top.document.body.clientHeight-70+'px','this');
		changeCSS('#tocIFrame','height',top.document.body.clientHeight-74+'px','this');
	}
...
function tocLoadDataProcess() {
	if (data.readyState == 4) {
		...
		try {
			...
			tocInitRoot++;
			if (tocInitRoot==2) {
				tocLoadData(tocTab[0][7].substring(1,tocTab[0][7].length-1)+".dat");
...
function toggleItem(item,type) {
	...
	if (browser=="ff"||browser=="op") {
		var contWHeight = cont.innerHeight-5;
		var contWWidth = cont.innerWidth;
	} else {
