 ...
 */
public class ManageEngineLicenseTest extends PlainTestCase {

    private static final String COPYRIGHT = "Copyright 2004-2012 the Seasar Foundation and the Others.";
