 ...
 */
public class DfCraftDiff extends DfAbstractDiff implements DfNestDiff {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    protected DfCraftDiff(String craftKeyName, DfDiffType diffType) {
        _craftKeyName = craftKeyName;
        _diffType = diffType;
    }

    protected DfCraftDiff(Map<String, Object> craftDiffMap) {
    ...
    public static DfCraftDiff createAdded(String craftKeyName) {
        return new DfCraftDiff(craftKeyName, DfDiffType.ADD);
    }

    public static DfCraftDiff createChanged(String craftKeyName) {
        return new DfCraftDiff(craftKeyName, DfDiffType.CHANGE);
    }

    public static DfCraftDiff createDeleted(String craftKeyName) {
        return new DfCraftDiff(craftKeyName, DfDiffType.DELETE);
    }

    public static DfCraftDiff createFromDiffMap(Map<String, Object> procedureDiffMap) {
        return new DfCraftDiff(procedureDiffMap);
    }
