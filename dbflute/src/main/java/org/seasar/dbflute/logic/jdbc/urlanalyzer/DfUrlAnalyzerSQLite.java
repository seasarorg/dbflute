 ...
 */
public class DfUrlAnalyzerSQLite extends DfUrlAnalyzerBase {

    public DfUrlAnalyzerSQLite(String url) {
        super(url);
    }

    protected String doExtractCatalog() {
        final String pureUrl = Srl.substringFirstFront(_url, ";", "?", "&");
        final String catalog = Srl.substringLastFront(Srl.substringLastRear(pureUrl, "/", ":"), ".");
