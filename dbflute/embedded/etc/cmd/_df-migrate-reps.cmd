...
if "%answer%"=="" set /P answer=LoadData will be migrated. Are you ready? (y or n) 
if "%answer%"=="y" (
  call %DBFLUTE_HOME%\etc\cmd\_df-copy-extlib.cmd

  call %DBFLUTE_HOME%\ant\bin\ant -Ddfenv=%DBFLUTE_ENVIRONMENT_TYPE% -f %DBFLUTE_HOME%\build-torque.xml migrate-reps
