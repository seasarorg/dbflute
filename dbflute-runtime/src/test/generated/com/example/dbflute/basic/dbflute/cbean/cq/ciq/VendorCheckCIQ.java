...
/**
 * The condition-inline-query of VENDOR_CHECK.
...
public class VendorCheckCIQ extends AbstractBsVendorCheckCQ {
    ...
    //                                                                ====================
    protected ConditionValue getCValueVendorCheckId() {
        return _myCQ.getVendorCheckId();
    }
    protected ConditionValue getCValueDecimalDigit() {
        return _myCQ.getDecimalDigit();
    }
    protected ConditionValue getCValueIntegerNonDigit() {
        return _myCQ.getIntegerNonDigit();
    }
    protected ConditionValue getCValueTypeOfBoolean() {
        return _myCQ.getTypeOfBoolean();
    }
    protected ConditionValue getCValueTypeOfText() {
        return _myCQ.getTypeOfText();
    }
