 ...
 */
public abstract class BsPurchaseMaxPriceMember implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is PurchaseMaxPriceMember. */
    public static final String TABLE = "PurchaseMaxPriceMember";
    ...
    /** PURCHASE_MAX_PRICE: {INTEGER(10,0)} */
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsPurchaseMaxPriceMember() {
    }
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.basic.dbflute.bsentity.customize.dbmeta.PurchaseMaxPriceMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        ...
        final BsPurchaseMaxPriceMember otherEntity = (BsPurchaseMaxPriceMember)other;
    ...
    public int hashCode() {
        ...
        if (this.getPurchaseMaxPrice() != null) { result = result + this.getPurchaseMaxPrice().hashCode(); }
    ...
    /** The column annotation for S2Dao. {INTEGER(10,0)} */
    public static final String purchaseMaxPrice_COLUMN = "PURCHASE_MAX_PRICE";

    /**
     * PURCHASE_MAX_PRICE: {INTEGER(10,0)} <br />
     * @return The value of the column 'PURCHASE_MAX_PRICE'. (Nullable)
     */
    ...
    /**
     * PURCHASE_MAX_PRICE: {INTEGER(10,0)} <br />
     * @param purchaseMaxPrice The value of the column 'PURCHASE_MAX_PRICE'. (Nullable)
     */
    public void setPurchaseMaxPrice(Integer purchaseMaxPrice) {
        _modifiedProperties.addPropertyName("purchaseMaxPrice");
