...
public class SimpleMemberDbm extends AbstractDBMeta {
    ...
    //                                                                          Table Info
    //                                                                          ==========
    public String getTableDbName() { return "SimpleMember"; }
    public String getTablePropertyName() { return "simpleMember"; }
    public String getTableSqlName() { return "SimpleMember"; }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.basic.dbflute.exentity.customize.SimpleMember"; }
    ...
    public void acceptPrimaryKeyMap(Entity entity, Map<String, ? extends Object> primaryKeyMap) {
        doAcceptPrimaryKeyMap((SimpleMember)entity, primaryKeyMap, _epsMap);
    }
    ...
    public void acceptColumnValueMap(Entity entity, Map<String, ? extends Object> columnValueMap) {
        doAcceptColumnValueMap((SimpleMember)entity, columnValueMap, _epsMap);
    }
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<SimpleMember>> _epsMap = StringKeyMap.createAsFlexibleConcurrent();
    {
    ...
    public void setupEntityProperty(String propertyName, Object entity, Object value) {
        findEps(_epsMap, propertyName).setup((SimpleMember)entity, value);
    }
    
    public static class EpsMemberId implements Eps<SimpleMember> {
        public void setup(SimpleMember e, Object v) { e.setMemberId((Integer)v); }
    }
    public static class EpsMemberName implements Eps<SimpleMember> {
        public void setup(SimpleMember e, Object v) { e.setMemberName((String)v); }
    }
    public static class EpsMemberStatusName implements Eps<SimpleMember> {
        public void setup(SimpleMember e, Object v) { e.setMemberStatusName((String)v); }
    }
}
