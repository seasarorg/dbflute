...
public abstract class BaseOptional<OBJ> {
    ...
    //                                                                          Definition
    //                                                                          ==========
    protected static final OptionalThingIfPresentAfter IF_PRESENT_AFTER_EMPTY = new OptionalThingIfPresentAfter() {
        public void orElse(OptionalThingNoneProcessor noArgLambda) {
        }
    };
    protected static final OptionalThingIfPresentAfter IF_PRESENT_AFTER_NONE_FIRE = new OptionalThingIfPresentAfter() {
        public void orElse(OptionalThingNoneProcessor noArgLambda) {
            if (noArgLambda == null) {
     ...
     */
    protected void callbackRequired(OptionalThingConsumer<OBJ> consumer) {
        if (consumer == null) {
            String msg = "The argument 'consumer' should not be null.";
            throw new IllegalArgumentException(msg);
        }
