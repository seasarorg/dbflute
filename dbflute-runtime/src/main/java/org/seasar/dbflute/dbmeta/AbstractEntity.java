...
import org.seasar.dbflute.dbmeta.accessory.EntityDerivedMap;
import org.seasar.dbflute.dbmeta.accessory.EntityModifiedProperties;
import org.seasar.dbflute.dbmeta.accessory.EntityUniqueDrivenProperties;
...
public abstract class AbstractEntity implements Entity, DerivedMappable, Serializable, Cloneable {
     ...
     */
    public <VALUE> VALUE derived(String aliasName) { // old style for compatible
        if (__derivedMap == null) {
            __derivedMap = newDerivedMap();
        }
        return __derivedMap.findDerivedValue(this, aliasName);
    }
