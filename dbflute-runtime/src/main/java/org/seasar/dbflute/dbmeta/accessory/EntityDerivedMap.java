 ...
 */
package org.seasar.dbflute.dbmeta.accessory;
...
import org.seasar.dbflute.exception.SpecifyDerivedReferrerPropertyValueNotFoundException;
import org.seasar.dbflute.exception.SpecifyDerivedReferrerUnknownAliasNameException;
import org.seasar.dbflute.exception.SpecifyDerivedReferrerUnmatchedPropertyTypeException;
import org.seasar.dbflute.exception.factory.ExceptionMessageBuilder;
import org.seasar.dbflute.optional.OptionalProperty;
...
public class EntityDerivedMap implements Serializable {
     ...
     */
    public <VALUE> OptionalProperty<VALUE> findDerivedValue(Entity entity, final String aliasName, Class<VALUE> propertyType) {
        if (aliasName == null) {
        ...
        try {
            ...
            return OptionalProperty.ofNullable(found, new OptionalThingExceptionThrower() {
     ...
     */
    public <VALUE> VALUE findDerivedValue(Entity entity, String aliasName) { // old style for compatible
        if (aliasName == null) {
            throw new IllegalArgumentException("The argument 'aliasName' should not be null.");
        }
