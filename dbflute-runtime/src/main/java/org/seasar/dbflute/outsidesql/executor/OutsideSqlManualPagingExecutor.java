...
public class OutsideSqlManualPagingExecutor<BEHAVIOR> extends AbstractOutsideSqlPagingExecutor<BEHAVIOR> {
     ...
     *     = memberBhv.outsideSql().manualPaging().<span style="color: #FD4747">selectPage</span>(pmb);
     ...
     */
    public <ENTITY> PagingResultBean<ENTITY> selectPage(ManualPagingHandlingPmb<BEHAVIOR, ENTITY> pmb) {
        if (pmb == null) {
     ...
     *     = memberBhv.outsideSql().manualPaging().<span style="color: #FD4747">selectList</span>(pmb);
