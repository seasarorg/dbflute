...
/**
 * The function for scalar select as prototype. 
 * @param <CB> The type of condition-bean.
 * @param <RESULT> The type of result for scalar select
 * @author jflute
 */
public class HpSLSProtoFunction<CB extends ConditionBean, RESULT> {
     ...
     */
    public HpSLSProtoFunction(CB conditionBean, Class<RESULT> resultType, HpSLSExecutor<CB, RESULT> executor) {
     ...
     */
    protected RESULT facadeCount(ScalarQuery<CB> scalarQuery) {
     ...
     * @return The count value calculated by function. (NotNull)
     */
    protected RESULT facadeCount(ScalarQuery<CB> scalarQuery, ScalarSelectOption option) {
     ...
     */
    protected RESULT facadeCountDistinct(ScalarQuery<CB> scalarQuery) {
     ...
     * @return The count-distinct value calculated by function. (NotNull)
     */
    protected RESULT facadeCountDistinct(ScalarQuery<CB> scalarQuery, ScalarSelectOption option) {
        assertScalarSelectOption(option);
     ...
     */
    protected RESULT facadeMax(ScalarQuery<CB> scalarQuery) {
     ...
     */
    protected RESULT facadeMax(ScalarQuery<CB> scalarQuery, ScalarSelectOption option) {
        assertScalarSelectOption(option);
     ...
     */
    protected RESULT facadeMin(ScalarQuery<CB> scalarQuery) {
     ...
     */
    protected RESULT facadeMin(ScalarQuery<CB> scalarQuery, ScalarSelectOption option) {
        assertScalarSelectOption(option);
     ...
     */
    protected RESULT facadeSum(ScalarQuery<CB> scalarQuery) {
     ...
     */
    protected RESULT facadeSum(ScalarQuery<CB> scalarQuery, ScalarSelectOption option) {
        assertScalarSelectOption(option);
     ...
     */
    protected RESULT facadeAvg(ScalarQuery<CB> scalarQuery) {
     ...
     */
    protected RESULT facadeAvg(ScalarQuery<CB> scalarQuery, ScalarSelectOption option) {
        assertScalarSelectOption(option);
