...
public interface HpCalculator {
     ...
     *  mob.<span style="color: #FD4747">plus</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     ...
     *      }
     *  }).<span style="color: #FD4747">plus</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     *  PurchaseCB cb = new PurchaseCB();
     *  ManualOrderBean mob = new ManualOrderBean
     *  mob.<span style="color: #FD4747">minus</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(mob);
     * 
     * e.g. ColumnQuery: ... > PURCHASE_PRICE - PURCHASE_COUNT
     *  PurchaseCB cb = new PurchaseCB();
     ...
     *          cb.columnPurchasePrice();
     *      }
     *  }).<span style="color: #FD4747">minus</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     *  PurchaseCB cb = new PurchaseCB();
     *  ManualOrderBean mob = new ManualOrderBean
     *  mob.<span style="color: #FD4747">multiply</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(mob);
     * 
     * e.g. ColumnQuery: ... > PURCHASE_PRICE * PURCHASE_COUNT
     *  PurchaseCB cb = new PurchaseCB();
     ...
     *          cb.columnPurchasePrice();
     *      }
     *  }).<span style="color: #FD4747">multiply</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     *  PurchaseCB cb = new PurchaseCB();
     *  ManualOrderBean mob = new ManualOrderBean
     *  mob.<span style="color: #FD4747">divide</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(mob);
     * 
     * e.g. ColumnQuery: ... > PURCHASE_PRICE / PURCHASE_COUNT
     *  PurchaseCB cb = new PurchaseCB();
     ...
     *          cb.columnPurchasePrice();
     *      }
     *  }).<span style="color: #FD4747">divide</span>(cb.<span style="color: #FD4747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
