...
/**
 * The function for (Specify)DerivedReferrer as prototype.
 * @param <REFERRER_CB> The type of referrer condition-bean.
 * @param <LOCAL_CQ> The type of local condition-query.
 * @author jflute
 */
public class HpSDRProtoFunction<REFERRER_CB extends ConditionBean, LOCAL_CQ extends ConditionQuery> {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public HpSDRProtoFunction(ConditionBean baseCB, LOCAL_CQ localCQ,
            HpSDRSetupper<REFERRER_CB, LOCAL_CQ> querySetupper, DBMetaProvider dbmetaProvider) {
        _baseCB = baseCB;
        _localCQ = localCQ;
     ...
     */
    protected void facadeCount(SubQuery<REFERRER_CB> subQuery, String aliasName) {
     ...
     */
    protected void facadeCount(SubQuery<REFERRER_CB> subQuery, String aliasName, DerivedReferrerOption option) {
     ...
     * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
     */
    protected void facadeCountDistinct(SubQuery<REFERRER_CB> subQuery, String aliasName) {
     ...
     * @param option The option for DerivedReferrer. For example, you can use a coalesce function. (NotNull)
     */
    protected void facadeCountDistinct(SubQuery<REFERRER_CB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertDerivedReferrerOption(option);
     ...
     * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
     */
    protected void facadeMax(SubQuery<REFERRER_CB> subQuery, String aliasName) {
     ...
     * @param option The option for DerivedReferrer. For example, you can use a coalesce function. (NotNull)
     */
    protected void facadeMax(SubQuery<REFERRER_CB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertDerivedReferrerOption(option);
     ...
     * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
     */
    protected void facadeMin(SubQuery<REFERRER_CB> subQuery, String aliasName) {
     ...
     * @param option The option for DerivedReferrer. For example, you can use a coalesce function. (NotNull)
     */
    protected void facadeMin(SubQuery<REFERRER_CB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertDerivedReferrerOption(option);
     ...
     * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
     */
    protected void facadeSum(SubQuery<REFERRER_CB> subQuery, String aliasName) {
     ...
     * @param option The option for DerivedReferrer. For example, you can use a coalesce function. (NotNull)
     */
    protected void facadeSum(SubQuery<REFERRER_CB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertDerivedReferrerOption(option);
     ...
     * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
     */
    protected void facadeAvg(SubQuery<REFERRER_CB> subQuery, String aliasName) {
     ...
     * @param option The option for DerivedReferrer. For example, you can use a coalesce function. (NotNull)
     */
    protected void facadeAvg(SubQuery<REFERRER_CB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertDerivedReferrerOption(option);
