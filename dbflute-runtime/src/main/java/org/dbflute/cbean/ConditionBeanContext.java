...
public class ConditionBeanContext {
    ...
    public static void loadCoolClasses() {
        ...
        {
            final Class<?> clazz = org.dbflute.cbean.SimplePagingBean.class;
            if (debugEnabled) { sb.append("  ...Loading class of " + clazz.getName() + " by " + clazz.getClassLoader().getClass()).append(getLineSeparator()); }
        }
		{
            Class<?> clazz = org.dbflute.AccessContext.class;
            clazz = org.dbflute.CallbackContext.class;
            clazz = org.dbflute.cbean.coption.FromToOption.class;
            clazz = org.dbflute.cbean.coption.LikeSearchOption.class;
            clazz = org.dbflute.cbean.coption.InScopeOption.class;
            clazz = org.dbflute.cbean.grouping.GroupingOption.class;
            clazz = org.dbflute.cbean.grouping.GroupingRowEndDeterminer.class;
            clazz = org.dbflute.cbean.grouping.GroupingRowResource.class;
            clazz = org.dbflute.cbean.grouping.GroupingRowSetupper.class;
            clazz = org.dbflute.cbean.pagenavi.PageNumberLink.class;
            clazz = org.dbflute.cbean.pagenavi.PageNumberLinkSetupper.class;
            clazz = org.dbflute.jdbc.CursorHandler.class;
    ...
    public static void throwEntityAlreadyDeletedException(Object searchKey4Log) {
        ...
        msg = msg + "* * * * * * * * * */";
        throw new org.dbflute.exception.EntityAlreadyDeletedException(msg);
    }
    ...
    public static void throwEntityDuplicatedException(String resultCountString, Object searchKey4Log, Throwable cause) {
        ...
        msg = msg + "* * * * * * * * * */";
        if (cause != null) {
            throw new org.dbflute.exception.EntityDuplicatedException(msg, cause);
        } else {
            throw new org.dbflute.exception.EntityDuplicatedException(msg);
        }
    }
	...
	public static String convertConditionBean2DisplaySql(ConditionBean cb
	    ...
	    return TnSqlParser.convertTwoWaySql2DisplaySql(twoWaySql, cb, logDateFormat, logTimestampFormat);
	}
