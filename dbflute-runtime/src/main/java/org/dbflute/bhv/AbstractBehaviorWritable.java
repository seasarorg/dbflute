...
import org.dbflute.bhv.batch.TokenFileReflectionFailure;
import org.dbflute.bhv.batch.TokenFileReflectionOption;
import org.dbflute.bhv.batch.TokenFileReflectionResult;
...
import org.dbflute.bhv.core.command.BatchDeleteEntityCommand;
import org.dbflute.bhv.core.command.BatchDeleteNonstrictEntityCommand;
import org.dbflute.bhv.core.command.BatchInsertEntityCommand;
import org.dbflute.bhv.core.command.BatchUpdateEntityCommand;
import org.dbflute.bhv.core.command.BatchUpdateNonstrictEntityCommand;
...
import org.dbflute.bhv.core.command.QueryUpdateEntityCBCommand;
...
import org.dbflute.helper.token.file.impl.FileTokenImpl;
...
public abstract class AbstractBehaviorWritable extends AbstractBehaviorReadable implements BehaviorWritable {
    ...
    protected <ENTITY extends Entity, CB_TYPE extends ConditionBean>
        ...
        if (!entity.hasPrimaryKeyValue()) {
            ...
            } catch (org.dbflute.exception.EntityAlreadyDeletedException e) {
                exception = e;
     ...
     * @exception org.dbflute.exception.EntityAlreadyUpdatedException If s2dao's version is over 1.0.47 (contains 1.0.47).
     */
