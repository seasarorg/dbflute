...
import org.dbflute.bhv.batch.TokenFileOutputOption;
import org.dbflute.bhv.batch.TokenFileOutputResult;
...
import org.dbflute.bhv.outsidesql.OutsideSqlBasicExecutor;
...
import org.dbflute.helper.token.file.FileMakingHeaderInfo;
...
public abstract class AbstractBehaviorReadable implements BehaviorReadable {
    ...
    protected <ENTITY extends Entity, CB extends ConditionBean>
        ...
        } catch (org.dbflute.exception.DangerousResultSizeException e) {
    ...
    public ListResultBean<Entity> readList(ConditionBean cb) {
        assertCBNotNull(cb);
        return new org.dbflute.cbean.ResultBeanBuilder<Entity>(getTableDbName()).buildListResultBean(cb, callReadList(cb));
    }
